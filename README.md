...
**در ادامه لیستی از این دستکاری‌های روانی آورده شده است. به همراه هر مورد، یک مثال ذکر شده است. می‌توانید روی هر کدام کلیک کنید و اطلاعات بیشتری بگیرید**
...
## [۱۲. تحقیر عمومی](public-humiliation.md)
